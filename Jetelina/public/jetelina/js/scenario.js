...
scenario["config-update-cmd"]=["change","replace","rewrite"];
...
scenario["cond-sql-performance-graph-show-cmd"]=["your suggestion","suggest","sql test","improved performance"];
...
scenario["func-subpanel-opened-cmd"]=["Set your sub query in \"Sub Query\" field","Ready to \"Sub Query\" field"];
...
scenario["hide-error-message-cmd"]=["hide error"];
scenario["show-error-message-cmd"]=["show error"];
