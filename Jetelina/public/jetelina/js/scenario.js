...
scenario["multi-candidates"]=["there are a few candidates as your order","which is your order?","may you should say more detail","please tell me more detail.","next question.","more..."];
scenario["not-registered"]=["you are not registered, try again.","you are not here yet.","I do not know you, sorry."];
...
scenario["func-post-err"]=["Hey, no columns","You should select post data","Boo"];
...
scenario["func-show-table-list"]=["open table","show me table","table list","tables","tablelist","tableslist"];
scenario["func-show-api-list"]=["open api","show me api","api list","apis list","apis","apilist"];
...
scenario["func-list-cmd-select-cmd"]=["select","choose","pick"];
scenario["func-selected-column-post-cmd"]=["post","send","push"];
...
scenario["func-tabledrop-confirm"]=["Sure?","Really?","Won\"t you regret?"];
scenario["func-tabledrop-cancel-cmd"]=["cancel","withdraw","abandon","postpone","give up","stop","quit"];
scenario["func-apidelete-cmd"]=["delete","delete api","api delete","apidelete","deleteapi"];
...
scenario["func-apidelete-confirm"]=["Sure?","Really?","Won\"t you regret?"];
...
scenario["func-csv-format-error"]=["CSV format is not good, see the error message","Unacceptable CSV format, see the error message,"];
...
scenario["func-subpanel-opened"]=["Set your sub query in \"Sub Query\" field","Ready to \"Sub Query\" field"];
scenario["func-postcolumn-cancel-cmd"]=["cancel","withdraw","abandon","postpone","give up","stop","quit"];
...
config["pg_password"]=["do not show it, of course"];
config["selectlimt"]=["limit"];
config["pg_port"]=["port"];
