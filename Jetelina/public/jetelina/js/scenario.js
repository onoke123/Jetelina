...
scenario["func-db-switch"]=["change database","change data base","change db","switch database","switch data base","switch db"];
scenario["func-select-db"]=["which database?","what database?","postgresql, mysql or redis?"];
scenario["func-determine-db"]=["do you wanna '{Q}' ?","switch to '{Q}' ?"];
scenario["func-use-postgresql"]=["postgresql","postgres","postgre"];
scenario["func-use-mysql"]=["mysql"];
scenario["func-use-redis"]=["redis"];
