...
scenario["general-thanks-cmd"]=["thank you","thanks","thx","nice","well done","great","awesome","genious","incredible","super"];
scenario["general-thanks-msg"]=["you're welcome","my pleasure, {Q}"];
scenario["what-did-i-say"]=["did i say","did i type"];
...
scenario["config-show-cmd"]=["show parameter","show me configuration","show server parameter","change parameter","parameter change","configuration change","change configuration","update configuration","configuration update","update parameter","parameter update","config change","change config","update config","config update"];
scenario["config-update-msg"]=["type '{Q}' for updating..or 'canel'"];
scenario["get-config-change-history-msg"]=["configuration history", "change history","update history"];
...
scenario["common-confirm-msg"]=["Sure?..or 'canel'","Really?..or 'canel'","Do it now?..or 'canel'"];
...
scenario["func-tabledrop-msg"]=["Which table do you want to drop?..or 'canel'","correct order is \"droptable <table name>\" and so on..or 'canel'"];
...
scenario["func-fileupload-upload-msg"]=["you've selected '{Q}'. then hit 'upload'..or 'canel'."];
...
scenario["func-postcolumn-available-msg"]=["Now you can hit \"post\"..or 'canel'","Do post them by \"post\"..or 'canel'","Type \"post\" now..or 'canel'"];
...
scenario["func-api-test-ready-msg"]=["all params set, type '{Q}'..or 'canel'","we are in ready, type '{Q}'..or 'canel'","here we go with typing '{Q}'..or 'canel'"];
...
scenario["func-api-test-done-msg"]=["api test done, attention 'OUT' and give me 'thanks' plz."];
...
scenario["func-select-db-msg"]=["which database?","what database?","postgresql, mysql or redis?"];
