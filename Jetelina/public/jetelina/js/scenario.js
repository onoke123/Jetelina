...
scenario["stats-api-access-numbers-list-show-cmd"]=["show api access","display api access","open api access"];
scenario["stats-api-access-numbers-list-hide-cmd"]=["for api access","hide api access","close api access"];
scenario["stats-api-exec-speed-show-cmd"]=["show api speed","show api speed of","display api speed","display api speed of","open api speed","open api speed of"];
scenario["stats-api-exec-speed-hide-cmd"]=["for api speed","hide api speed","close api speed"];
scenario["stats-db-access-numbers-chart-show-cmd"]=["show db access","display db access","show database access","display database access","open database access"];
...
scenario["stats-all-graph-hide-cmd"]=["hide all stats","hide every graph","clear all graphs","all graphs clear","every stats clear","clear every stats"];
