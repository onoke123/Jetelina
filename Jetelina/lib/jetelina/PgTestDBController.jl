...
function create_jetelina_table()
    ...
    try
        ...
        JetelinaLog.writetoLogfile("PgTestDBController.create_jetelina_table() error: $err")
    finally
        close_connection(conn)
    end
end
...
function create_jetelina_id_sequence()
    ...
    try
        ...
        JetelinaLog.writetoLogfile("PgTestDBController.create_jetelina_id_sequence() error: $err")
    finally
        close_connection(conn)
    end
end
...
function readJetelinatable()
    ...
    try
        ...
        JetelinaLog.writetoLogfile("PgTestDBController.readJetelinatable() error: $err")
        return false
    finally
        close_connection(conn)
    end
...
function _getTableList()
    ...
    try
        ...
        JetelinaLog.writetoLogfile("PgTestDBController._getTableList() error: $err")
...
function getJetelinaSequenceNumber(t)
    ...
    try
        ...
        JetelinaLog.writetoLogfile("PgTestDBController.getJetelinaSequenceNumber() error: $err")
    finally
        close_connection(conn)
    end
...
function insert2JetelinaTableManager(tableName, columns)
    ...
    try
        ...
        JetelinaLog.writetoLogfile("PgTestDBController.insert2JetelinaTableManager() error: $err")
        return false
    finally
        close_connection(conn)
    end
...
#    column_type_string = Array{Union{Nothing,String}}(nothing, size(column_name))
    ...
    try
        ...
        close_connection(conn)
        println(err)
        JetelinaLog.writetoLogfile("PgTestDBController.dataInsertFromCSV() with $fname error : $err")
        return false
    finally
...
function dropTable(tableName)
    ...
    try
        ...
        println(err)
        JetelinaLog.writetoLogfile("PgTestDBController.dropTable() with $tableName error : $err")
        return false
    finally
        close_connection(conn)
    end
...
function getColumns(tableName)
    ...
    try
        ...
        JetelinaLog.writetoLogfile("PgTestDBController.getColumns() with $tableName error : $err")
    finally
        close_connection(conn)
    end
...
function getUserAccount(s)
    ...
    try
        ...
        JetelinaLog.writetoLogfile("PgTestDBController.getUserAccount() with $s error : $err")
    finally
        close_connection(conn)
    end
