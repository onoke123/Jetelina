"""
    ...
    functions
        ...
        executeApi(d::Dict) execute API with creating SQL sentence
...
function executeApi(d::Dict)
    #===
        Tips:
            Steps
                ...
                4.json data bind to the sql sentence
    ...
    ===#
    target_api = subset(Df_JetelinaSqlList, :apino => ByRow(==(d["apino"])), skipmissing=true)
